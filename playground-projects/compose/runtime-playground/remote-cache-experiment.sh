...
do
    ...
    then
        cache='transforms'
        disabledCacheArgs='-Dorg.gradle.internal.transform-caching-disabled=org.jetbrains.kotlin.gradle.internal.transforms.ClasspathEntrySnapshotTransform,com.android.build.gradle.internal.dependency.EnumerateClassesTransform,org.jetbrains.kotlin.gradle.internal.kapt.incremental.StructureTransformAction,com.android.build.gradle.internal.dependency.AarResourcesCompilerTransform,com.android.build.gradle.internal.dependency.ExtractJniTransform'
    fi
